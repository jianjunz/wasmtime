...
pub mod wasi {
    ...
    pub mod nn {
            ...
            impl ::core::fmt::Debug for ErrorCode {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        ErrorCode::TooLarge => f.debug_tuple("ErrorCode::TooLarge").finish(),
                        ErrorCode::NotFound => f.debug_tuple("ErrorCode::NotFound").finish(),
                        ErrorCode::Security => f.debug_tuple("ErrorCode::Security").finish(),
                        ErrorCode::Unknown => f.debug_tuple("ErrorCode::Unknown").finish(),
                    }
                }
            }
        ...
        pub mod graph {
            ...
            use super::super::super::_rt;
            pub type Error = super::super::super::wasi::nn::errors::Error;
            pub type GraphExecutionContext =
                super::super::super::wasi::nn::inference::GraphExecutionContext;
            ...
            impl ::core::fmt::Debug for GraphEncoding {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ...
                        GraphEncoding::Onnx => f.debug_tuple("GraphEncoding::Onnx").finish(),
                        GraphEncoding::Tensorflow => {
                            f.debug_tuple("GraphEncoding::Tensorflow").finish()
                        }
                        GraphEncoding::Pytorch => f.debug_tuple("GraphEncoding::Pytorch").finish(),
                        GraphEncoding::Tensorflowlite => {
                            f.debug_tuple("GraphEncoding::Tensorflowlite").finish()
                        }
                        GraphEncoding::Ggml => f.debug_tuple("GraphEncoding::Ggml").finish(),
            ...
            impl ::core::fmt::Debug for ExecutionTarget {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        ExecutionTarget::Cpu => f.debug_tuple("ExecutionTarget::Cpu").finish(),
                        ExecutionTarget::Gpu => f.debug_tuple("ExecutionTarget::Gpu").finish(),
                        ExecutionTarget::Tpu => f.debug_tuple("ExecutionTarget::Tpu").finish(),
                    }
                }
            }
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:chat:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 12121] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xde]\x01A\x02\x01AU\x01\
...
seed\x01\x01\x03\x01\x1fwasi:random/insecure-seed@0.2.0\x05+\x01B\x11\x01py\x04\0\
\x11tensor-dimensions\x03\0\0\x01m\x07\x04FP16\x04FP32\x04FP64\x04BF16\x02U8\x03\
...
\x0c\x03\x01\x0ewasi:nn/tensor\x05,\x01B\x0b\x01m\x09\x10invalid-argument\x10inv\
alid-encoding\x07timeout\x0druntime-error\x15unsupported-operation\x09too-large\x09\
not-found\x08security\x07unknown\x04\0\x0aerror-code\x03\0\0\x04\0\x05error\x03\x01\
\x01i\x02\x01@\x02\x04code\x01\x04datas\0\x03\x04\0\x12[constructor]error\x01\x04\
\x01h\x02\x01@\x01\x04self\x05\0\x01\x04\0\x12[method]error.code\x01\x06\x01@\x01\
\x04self\x05\0s\x04\0\x12[method]error.data\x01\x07\x03\x01\x0ewasi:nn/errors\x05\
-\x02\x03\0\x1c\x05error\x02\x03\0\x1b\x06tensor\x02\x03\0\x1b\x0btensor-data\x01\
B\x12\x02\x03\x02\x01.\x04\0\x05error\x03\0\0\x02\x03\x02\x01/\x04\0\x06tensor\x03\
\0\x02\x02\x03\x02\x010\x04\0\x0btensor-data\x03\0\x04\x04\0\x17graph-execution-\
context\x03\x01\x01h\x06\x01i\x03\x01i\x01\x01j\0\x01\x09\x01@\x03\x04self\x07\x04\
names\x06tensor\x08\0\x0a\x04\0)[method]graph-execution-context.set-input\x01\x0b\
\x01@\x01\x04self\x07\0\x0a\x04\0'[method]graph-execution-context.compute\x01\x0c\
\x01j\x01\x08\x01\x09\x01@\x02\x04self\x07\x04names\0\x0d\x04\0*[method]graph-ex\
ecution-context.get-output\x01\x0e\x03\x01\x11wasi:nn/inference\x051\x02\x03\0\x1d\
\x17graph-execution-context\x01B\x1a\x02\x03\x02\x01.\x04\0\x05error\x03\0\0\x02\
\x03\x02\x01/\x04\0\x06tensor\x03\0\x02\x02\x03\x02\x012\x04\0\x17graph-executio\
n-context\x03\0\x04\x04\0\x05graph\x03\x01\x01m\x07\x08openvino\x04onnx\x0atenso\
rflow\x07pytorch\x0etensorflowlite\x04ggml\x0aautodetect\x04\0\x0egraph-encoding\
\x03\0\x07\x01m\x03\x03cpu\x03gpu\x03tpu\x04\0\x10execution-target\x03\0\x09\x01\
p}\x04\0\x0dgraph-builder\x03\0\x0b\x01h\x06\x01i\x05\x01i\x01\x01j\x01\x0e\x01\x0f\
\x01@\x01\x04self\x0d\0\x10\x04\0$[method]graph.init-execution-context\x01\x11\x01\
p\x0c\x01i\x06\x01j\x01\x13\x01\x0f\x01@\x03\x07builder\x12\x08encoding\x08\x06t\
arget\x0a\0\x14\x04\0\x04load\x01\x15\x01@\x01\x04names\0\x14\x04\0\x0cload-by-n\
ame\x01\x16\x03\x01\x0dwasi:nn/graph\x053\x01B\x03\x01j\0\0\x01@\0\0\0\x04\0\x03\
run\x01\x01\x04\x01\x12wasi:cli/run@0.2.0\x054\x04\x01\x16example:chat-ggml/chat\
\x04\0\x0b\x0a\x01\0\x04chat\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
